...
(function() {
	const PROXY_MAP = {
		'https://files.luckyblocks.io': '/proxy/luckyblocks/files',
		'https://usa-1.luckyblocks.io': '/proxy/luckyblocks/usa-1',
		'https://usa-2.luckyblocks.io': '/proxy/luckyblocks/usa-2',
		'https://luckyblocks.io': '/proxy/luckyblocks',
	};

	const WS_SERVERS = [
		'usa-1.luckyblocks.io',
		'usa-2.luckyblocks.io',
	];
