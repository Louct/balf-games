// Proxy patch: redirect all game server requests through our Caddy proxy
(function() {
	const PROXY_MAP = {
		'https://files.2v2.io': '/proxy/2v2/files',
		'https://usa-1.2v2.io': '/proxy/2v2/usa-1',
		'https://usa-2.2v2.io': '/proxy/2v2/usa-2',
		'https://usa-3.2v2.io': '/proxy/2v2/usa-3',
		'https://usa-4.2v2.io': '/proxy/2v2/usa-4',
		'https://fra-1.2v2.io': '/proxy/2v2/fra-1',
		'https://fra-2.2v2.io': '/proxy/2v2/fra-2',
		'https://asia-1.2v2.io': '/proxy/2v2/asia-1',
		'https://2v2.io': '/proxy/2v2',
	};
			...
			for (const server of WS_SERVERS) {
				if (url.includes(server)) {
					...
					url = (location.protocol === 'https:' ? 'wss' : 'ws')
						+ '://' + location.host
						+ '/wsproxy/' + hostPort + parsed.pathname + parsed.search;
					break;
				}
			}
		}
...
function showAd(adType) {
    // Fake ad: immediately signal success to Unity
    setTimeout(function() {
        if (typeof unityInstance !== 'undefined') {
            unityInstance.SendMessage("SDKManager", "OnVideoAdEnded", "true");
        }
