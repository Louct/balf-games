...
const GAME_AUTH_URL = IS_PLAYTEST_LINK ? '/proxy/stealnow-dev-auth/' : '/proxy/stealnow-auth/';
...
/**
 * Validates that the auth result is from the Stealnow game server, not raw Legion data.
